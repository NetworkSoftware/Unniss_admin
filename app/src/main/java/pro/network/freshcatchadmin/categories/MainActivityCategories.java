...
public class MainActivityCategories extends AppCompatActivity implements CategoriesClick {
    private static final String TAG = pro.network.freshcatchadmin.categories.MainActivityCategories.class.getSimpleName();
    ProgressDialog progressDialog;
    private RecyclerView recyclerView;
    private List<Categories> categoriesList;
    private pro.network.freshcatchadmin.categories.CategoriesAdapter mAdapter;
