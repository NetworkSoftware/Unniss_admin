package pro.network.freshcatchadmin.categories;
...
import pro.network.freshcatchadmin.app.GlideApp;
import pro.network.freshcatchadmin.app.Imageutils;

import static pro.network.freshcatchadmin.app.Appconfig.CATEGORIES_CREATE;
                ...
                try {
                    ...
                    if (!jsonObject.getBoolean("error")) {
                        GlideApp.with(getApplicationContext())
                                ...
                                .placeholder(R.drawable.fresh_icon)
                                .into(profiletImage);
