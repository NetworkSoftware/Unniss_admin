package pro.network.freshcatchadmin.product;
...
import pro.network.freshcatchadmin.app.ActivityMediaOnline;
import pro.network.freshcatchadmin.app.AndroidMultiPartEntity;
import pro.network.freshcatchadmin.app.AppController;
import pro.network.freshcatchadmin.app.Appconfig;
import pro.network.freshcatchadmin.app.Imageutils;

import static pro.network.freshcatchadmin.app.Appconfig.CATEGORIES_GET_ALL;
import static pro.network.freshcatchadmin.app.Appconfig.CATEGORY;
import static pro.network.freshcatchadmin.app.Appconfig.PRODUCT_DELETE;
import static pro.network.freshcatchadmin.app.Appconfig.PRODUCT_UPDATE;
import static pro.network.freshcatchadmin.app.Appconfig.QTY_TYPE;
