package pro.network.jsbroilersadmin.categories;
...
public class MainActivityCategories extends AppCompatActivity implements CategoriesClick {
    private static final String TAG = pro.network.jsbroilersadmin.categories.MainActivityCategories.class.getSimpleName();
    ProgressDialog progressDialog;
    private RecyclerView recyclerView;
    private List<Categories> categoriesList;
    private pro.network.jsbroilersadmin.categories.CategoriesAdapter mAdapter;
