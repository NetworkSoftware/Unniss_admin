...
import static pro.network.unnissadmin.app.Appconfig.BANNERS_CREATE;
...
public class  BannerRegister extends AppCompatActivity implements Imageutils.ImageAttachmentListener{
    ...
    public void image_attachment(int from, String filename, Bitmap file, Uri uri) {
        ...
        pDialog.setMessage("Uploading...");
        showDialog();
        new UploadFileToServer().execute(Appconfig.compressImage(storedFile.getPath(),BannerRegister.this));
